            ...
            <div class="md:w-9/12">
                <div id="slider" class="">
                    <div class="gallery-slider mb-4">
                            ...
                            <div style="background-image: url(/ij/test.jpg)" class="single-gallery-item bg-cover bg-center"></div>
                    ...
                    <div class="thumbnail-slider">
                            ...
                            <div class="single-thumbnail-item">
                                <div style="background-image: url()" class="bg-cover bg-center h-full w-full"></div>
                            </div>
